...
project-cosmos: main.o inventory_mode.o classes.o draw.o generate.o bar.o help_mode.o
	g++ -g  -std=c++17 draw.o main.o inventory_mode.o classes.o generate.o bar.o help_mode.o -o project-cosmos -Wl,-Bstatic `pkg-config libtcod --cflags --libs` -Wl,-Bdynamic `sdl2-config --cflags --libs` -lpthread -lz -ldl
clean:
	rm -f main.o inventory_mode.o classes.o draw.o generate.o bar.o help_mode.o
