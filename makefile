...
project-cosmos: main.o inventory_mode.o classes.o draw.o generate.o bar.o help_mode.o
	g++ -static-libstdc++ -static-libgcc -g -O2 -std=c++17 draw.o main.o inventory_mode.o classes.o generate.o bar.o help_mode.o -o wayventure -Llibs/ -ltcod -lSDL2 -lpthread -lz -ldl
clean:
	rm -f main.o inventory_mode.o classes.o draw.o generate.o bar.o help_mode.o wayventure
